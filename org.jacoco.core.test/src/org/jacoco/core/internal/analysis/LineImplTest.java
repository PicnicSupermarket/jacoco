...
public class LineImplTest {
	...
	public void testIncrement4() {
		line = line.increment(CounterImpl.getInstance(1, 2000), 2000,
				CounterImpl.getInstance(3000, 4000));
	...
	public void testIncrement5() {
		line = line.increment(CounterImpl.getInstance(1000, 2000), 2000,
				CounterImpl.getInstance(3000, 4000));
	...
	public void testGetStatus3() {
		line = line.increment(CounterImpl.getInstance(0, 1), 1,
				CounterImpl.getInstance(0, 0));
	...
	public void testGetStatus5() {
		line = line.increment(CounterImpl.getInstance(1, 1), 1,
				CounterImpl.getInstance(0, 0));
	...
	public void testEquals3() {
		line = line.increment(CounterImpl.getInstance(111, 222), 222,
				CounterImpl.getInstance(333, 444));
		LineImpl line2 = LineImpl.EMPTY;
		line2 = line2.increment(CounterImpl.getInstance(111, 2220), 2220,
				CounterImpl.getInstance(333, 444));
