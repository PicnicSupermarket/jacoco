...
class ProbeInserter extends MethodVisitor implements IProbeInserter {
    ...
    /**
     * Insert bytecode (a probe) to increment the position corresponding to the given {@code id} in the int[] array
     *
     * @param id the position to increment
     */
    public void insertProbe(final int id) {
		...
		// Stack[1]: I
		// Stack[0]: [I
		// Duplicate the top two stack items as we want to do both lookup and storage.
		...
		// Stack[1]: I
		// Stack[0]: [I
		// Add an integer with value 1 on the stack (the value we will increment with)
		...
		// Stack[1]: I
		// Stack[0]: [I
		// Store the summed value in the integer array at the index which we already had on the stack
