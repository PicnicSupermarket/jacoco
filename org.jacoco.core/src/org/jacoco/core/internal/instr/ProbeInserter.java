...
class ProbeInserter extends MethodVisitor implements IProbeInserter {
	...
	public void insertProbe(final int id) {
		// TODO: We should not use BASTORE but IASTORE and we should not just set to 1 but increase the value.
		//	We should check this with the generated bytecode from such an action
		//	Perhaps the following:
		//
		// 	Empty stack
		//  ALOAD variable // Load reference to probe data
		//
		//  [I
		//	InstrSupport.push(mv, id); // Pushes the index of the array we want to retrieve
		//
		// 	I I[
		//	DUP2  // Duplicate the two items on the stack
		//
		// 	I [I I [I
		//  IALOAD // Extracts the value from the array
		//
		// 	I I [I
		//  ICONST_1 // Load value 1 onto the stack
		//
		// 	I I I [I
		//  IADD 	 // Adds two ints
		//
