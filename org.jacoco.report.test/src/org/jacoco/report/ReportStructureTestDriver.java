...
public class ReportStructureTestDriver {
	...
	public ReportStructureTestDriver() {
		...
		m.increment(CounterImpl.getInstance(3, 5),
				CounterImpl.getInstance(3, 10), CounterImpl.COUNTER_0_0, 1);
		m.increment(CounterImpl.getInstance(3, 5),
				CounterImpl.getInstance(3, 10), CounterImpl.getInstance(1, 2),
				2);
		m.increment(CounterImpl.getInstance(4, 5),
				CounterImpl.getInstance(4, 10), CounterImpl.COUNTER_0_0, 4);
